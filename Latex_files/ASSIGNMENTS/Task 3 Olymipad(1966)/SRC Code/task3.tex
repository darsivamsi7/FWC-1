...
\textbf{Eight International Olympiad, 1966}
}
\end{center}
\section*{1966/1}
...
\section*{1966/4}
Prove that for every natural number $n$, and for every real number
$
x \neq \frac{k\pi}{2^t}\qquad(t=0,1,\ldots,n;\ k \text{ any integer})
$
we have
$$
\frac{1}{\sin 2x}+\frac{1}{\sin 4x}+\cdots+\frac{1}{\sin 2^{n}x}
=
\cot{x}-\cot{2^{n}x}.
$$
\section*{1966/5}
...
$$
$$
|a_{2}-a_{1}|x_{1}+|a_{2}-a_{3}|x_{3}+|a_{2}-a_{4}|x_{4}=1
$$
$$
|a_{3}-a_{1}|x_{1}+|a_{3}-a_{2}|x_{2}=1
$$
$$
