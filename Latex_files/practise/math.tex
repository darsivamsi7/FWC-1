...
\begin{enumerate}
    \item[\textcolor{blue}{13}] $ \tan\left(\frac{1}{2}\right) \left[ \sin^{-1}\left(\frac{2x}{1+x^2}\right) + \cos^{-1}\left(\frac{1-y^2}{1+y^2}\right) \right] , \ |x| < 1, \ y > 0, \ xy < 1$    \item[\textcolor{blue}{14}] $ \sin \left( \sin^{-1}\left( \frac{1}{5} \right) + \cos^{-1}(x) \right) = 1, \ \text{find } x$
